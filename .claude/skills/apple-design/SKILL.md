---
name: apple-design
description: How Apple builds interfaces that feel like a natural extension of the user, distilled from WWDC design talks (Designing Fluid Interfaces, Designing Audio-Haptic Experiences, The Details of UI Typography, Principles of Great Design) and translated to the web platform (CSS, Pointer Events, requestAnimationFrame, spring libraries like Motion/Framer Motion). Use when building or reviewing any interactive UI, animation, gesture, transition, drawer/sheet, translucent surface, or typography scale — anywhere motion, touch, or visual craft matters.
---
...
**Desktop/information-dense work (sidebars, toolbars, data tables, wizards, settings panes):** this file is sourced from mobile/gesture-heavy WWDC talks and under-specifies desktop app structure. Read `desktop-web-apps.md` in this same skill directory first — it covers macOS HIG's sidebar/toolbar/table/wizard/settings conventions that this file doesn't.
